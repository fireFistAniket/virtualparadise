  ...
  return (
    <div className="relative">
      ...
      <button
        ...
        className="text-[2vmax] hidden md:inline-block text-neutral-100 bg-black bg-opacity-60 h-full absolute top-0 left-0 md:opacity-0 hover:opacity-100 transition duration-500"
        type="button"
      >
      ...
      <button
        ...
        className="text-[2vmax] hidden md:inline-block text-neutral-100 bg-black bg-opacity-60 h-full absolute top-0 right-0 md:opacity-0 hover:opacity-100 transition duration-500"
        type="button"
      >

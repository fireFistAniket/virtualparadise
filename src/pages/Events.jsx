...
const Events = () => {
  ...
  return (
    <>
      <TitleManager title={"VirtualParadise | Events"} />
      <main className="min-h-[80vmin] flex flex-col gap-[5vmin] my-[1.4vmin]">
        <div className="bg-[url('/events-header-bg.png')] bg-cover bg-center bg-no-repeat flex items-center justify-center min-h-[45vmin] md:min-h-[70vmin]">
        ...
        <h1 className="text-center text-[2.7vmax] font-bold text-neutral-100">
          Witness The recent Game Launch events
        </h1>
        <div

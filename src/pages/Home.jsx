          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-[2vmax]">
            <div className="max-w-[35vmax] md:max-w-[45vmax] xl:max-w-[55vmax] text-[1.2vmax] text-neutral-100">
              <p className="whitespace-pre-wrap">
                ...
                VirtualParadise, we're more than just a database of games. We're
                a passionate community of gamers who are dedicated to sharing
                our love for virtual worlds with others. Our goal is to create a
                ...
                the vast world of virtual entertainment, we invite you to join
                us on this exciting journey. So come on in, and let's start
                exploring the virtual paradise together!
              </p>
            </div>
            <div>
              <img
        ...
        <div className="flex flex-col items-center justify-center gap-[3vmax] mx-[3vmax]">
          ...
          <div className="grid grid-cols-2 gap-[1.5vmax] items-center justify-items-center md:min-w-[85vmax]">
            ...
            <div className="flex items-center justify-center gap-4 max-w-[25vmax]">
              ...
              <p className="text-[1.1vmax] text-neutral-100 font-medium">
                We always try to bring best of bests game and latest news to
                you.
              </p>
            </div>
          </div>
        ...
        <div className="flex flex-col items-center md:items-stretch md:flex-row mx-[3vmax] gap-[2.5vmax]">
          ...
          <div className="flex flex-col gap-[1.7vmax] items-center md:items-start justify-around max-w-[50vmax]">
            ...
            <p className="text-[1.4vmax] font-medium text-neutral-100">
              ...
              sit delectus est accusantium modi possimus adipisci ducimus,
              cumque quo perferendis harum eum magni vero. Velit et molestiae
              dolores aliquid.
            </p>
            <Link
              to="/genres"
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center">
            <div className="flex flex-col items-center justify-center gap-[2vmin]">
              <p className="text-[1.4vmax] font-medium text-neutral-100">
                ...
                rescue Princess Peach from the villain Bowser. Mario is known
                for his jumping ability and has starred in numerous games across
                various genres, becoming one of the most recognizable and
                enduring characters in gaming history.
              </p>
              <img
                src={`${
                  import.meta.env.VITE_IMAGE_URI
                }/iurhmhenrrsdnsc4zbva.png`}
                alt="Lara Croft"
                width={1920}
                height={1080}
            ...
            <div className="flex flex-col-reverse sm:flex-col items-center justify-center gap-[2vmin]">
              ...
              <p className="text-[1.4vmax] font-medium text-neutral-100">
                ...
                Assassin&apos;s Creed video game series. He is an Italian
                nobleman who becomes an Assassin after his family is betrayed
                and killed. Known for his charisma and skill, Ezio is a master
                of stealth, combat, and parkour. His story is set during the
                Italian Renaissance, where he fights against the Templar Order.
                Ezio&apos;s journey is marked by personal growth, from a young
                man seeking revenge to a wise mentor guiding future generations
                of Assassins.
              </p>
            </div>
          </div>
